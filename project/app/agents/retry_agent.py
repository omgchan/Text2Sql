...
PROMPT_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "prompts", "retry_prompt.txt"))
...
def _load_prompt() -> str:
    try:
        ...
        return "Given decomposition, previous SQL, and DB error, produce a corrected SELECT SQL. Return only SQL."


def generate_fix(decomposition: Dict[str, Any], previous_sql: str, error: str, temperature: float = 0.0) -> str:
